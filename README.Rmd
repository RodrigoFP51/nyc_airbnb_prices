...
A partir disso desenvolvi um aplicativo em Streamlit em que o usuário pode fornecer dados de um imóvel (vizinhança, número de reviews, a quantidade de dias que o imóvel fica disponivel no ano)
e partir disso o aluguel é calculado.
